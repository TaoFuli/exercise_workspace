 ...
 * Generated at: 2018-12-07 08:07:13 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/buy.css\" />\r\n");
      ...
      out.write("$(function(){\r\n");
      out.write("\t$('#menu').tree({\r\n");
      out.write("\t\t//给tree节点添加点击事件\r\n");
      out.write("\t\tonClick: function(node){//node->当前点击的节点\r\n");
      out.write("\t\t\tif($('#menu').tree(\"isLeaf\",node.target)){//判断当前点击的节点是否是叶子节点\r\n");
      out.write("\t\t\t\tvar tabs = $(\"#tabs\");//选中标签页\r\n");
      out.write("\t\t\t\tvar tab = tabs.tabs(\"getTab\",node.text);//根据点击的节点获取标签\r\n");
      out.write("\t\t\t\tif(tab){\r\n");
      out.write("\t\t\t\t    //如果能够获取到标签 说明已经打开了 只需要重新定位到当前的标签即可\r\n");

...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:#F3F3F3"> 
		<span class="northTitle">易购Buy商城后台管理系统</span>
...
$(function(){
	$('#menu').tree({
		//给tree节点添加点击事件
		onClick: function(node){//node->当前点击的节点
			if($('#menu').tree("isLeaf",node.target)){//判断当前点击的节点是否是叶子节点
				var tabs = $("#tabs");//选中标签页
				var tab = tabs.tabs("getTab",node.text);//根据点击的节点获取标签
				if(tab){
				    //如果能够获取到标签 说明已经打开了 只需要重新定位到当前的标签即可
